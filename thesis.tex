...
After every run, histograms-generating scripts are triggered to store histograms of free space and used space fragmentation. Also outputs of the \textit{fs-drift} script and \textit{df} command are logged.

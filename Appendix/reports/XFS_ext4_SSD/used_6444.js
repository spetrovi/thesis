...
used_6444= new Highcharts.Chart({
      chart: {zoomType: 'xy',
      width: 600,
      height: 400,
...
subtitle: {text: 'extents: 157448, total files: 623814, optimal files: 98%'},
...
color: 'rgba(0, 0, 255, 0.50)',
	type: 'column',
	data: [0, 0, 0, 0, 0, 0, 0, 31272, 22385, 18096, 19022, 16673, 15014, 11694, 9787, 8091, 2955, 1431, 626, 263, 108, 27, 4, 0, 0, 0, 0, 0, 0, 0],visible: true,
...
color:'rgba(0, 255, 0, 0.50)',
	type: 'column',
	data: [0, 0, 0, 0, 0, 0, 0, 340429, 60516, 55015, 46850, 37335, 27867, 19143, 12338, 7151, 3839, 2014, 857, 369, 127, 51, 15, 0, 0, 0, 0, 0, 0, 0],visible: true,
    ...
    $('#used_6444_button').click(function () {used_6444.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
subtitle: {text: 'extents: 83701, total files: 680154, optimal files: 98%'},
...
color: 'rgba(0, 0, 255, 0.50)',
	type: 'column',
	data: [0, 0, 0, 0, 0, 0, 0, 1730, 453, 795, 960, 10055, 15104, 23006, 17131, 8072, 3550, 1606, 745, 342, 120, 28, 4, 0, 0, 0, 0, 0, 0, 0],visible: true,
...
color:'rgba(0, 255, 0, 0.50)',
	type: 'column',
	data: [0, 0, 0, 0, 0, 0, 0, 371954, 65936, 59639, 50979, 41005, 30817, 21316, 12977, 7756, 4230, 2065, 939, 399, 159, 38, 14, 0, 0, 0, 0, 0, 0, 0],visible: true,
    ...
    $('#used_223_button').click(function () {used_223.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
\begin{figure}[!htb]
   ...
   \begin{minipage}{\textwidth}
        ...
        \includegraphics[width=\textwidth]{../charts/HDD_ext4/o}
                \caption[Evolution of latencies while testing EXT4 during testing of high utilisation of HDD]{On these charts, we can see evolution of latencies of conducted IO operations during testing EXT4 with high utilisation. Progressively larger fluctuations can be seen in operations random write, truncate and read.}
\label{fig:lats_ext4}
    \end{minipage}
\end{figure}

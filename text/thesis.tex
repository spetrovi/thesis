...
Solid state driveis a type of storage device which use integrated cirquit to store and retreive data. SSD has no moving parts, so the data access is purely electronic, which results in lower access time and latency than HDD.

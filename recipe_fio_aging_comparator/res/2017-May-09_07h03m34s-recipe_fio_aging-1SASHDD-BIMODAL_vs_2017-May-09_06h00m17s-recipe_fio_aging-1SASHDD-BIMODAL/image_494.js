...
// Set up the chart
var image_494_chart;
$(document).ready(function () {image_494_chart= new Highcharts.Chart({
...
$(image_494_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_494_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_494_chart.options.chart.options3d.alpha,
    beta = image_494_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_494_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_494_chart.options.chart.options3d.alpha = newAlpha;

      image_494_chart.redraw(false);
    },
...
var image_494_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_494_button').click(function () {image_494.yAxis[0].update({
            type: types[type]
        });
type += 1;

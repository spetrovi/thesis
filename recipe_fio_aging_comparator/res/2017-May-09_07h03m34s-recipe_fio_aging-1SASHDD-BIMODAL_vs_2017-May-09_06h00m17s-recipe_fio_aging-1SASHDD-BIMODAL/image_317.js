...
// Set up the chart
var image_317_chart;
$(document).ready(function () {image_317_chart= new Highcharts.Chart({
...
$(image_317_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_317_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_317_chart.options.chart.options3d.alpha,
    beta = image_317_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_317_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_317_chart.options.chart.options3d.alpha = newAlpha;

      image_317_chart.redraw(false);
    },
...
var image_317_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_317_button').click(function () {image_317.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_544_chart;
$(document).ready(function () {image_544_chart= new Highcharts.Chart({
...
$(image_544_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_544_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_544_chart.options.chart.options3d.alpha,
    beta = image_544_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_544_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_544_chart.options.chart.options3d.alpha = newAlpha;

      image_544_chart.redraw(false);
    },
...
var image_544_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_544_button').click(function () {image_544.yAxis[0].update({
            type: types[type]
        });
type += 1;

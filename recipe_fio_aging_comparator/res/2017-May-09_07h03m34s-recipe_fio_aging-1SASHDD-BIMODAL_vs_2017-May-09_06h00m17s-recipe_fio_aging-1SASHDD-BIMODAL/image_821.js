...
// Set up the chart
var image_821_chart;
$(document).ready(function () {image_821_chart= new Highcharts.Chart({
...
$(image_821_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_821_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_821_chart.options.chart.options3d.alpha,
    beta = image_821_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_821_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_821_chart.options.chart.options3d.alpha = newAlpha;

      image_821_chart.redraw(false);
    },
...
var image_821_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_821_button').click(function () {image_821.yAxis[0].update({
            type: types[type]
        });
type += 1;

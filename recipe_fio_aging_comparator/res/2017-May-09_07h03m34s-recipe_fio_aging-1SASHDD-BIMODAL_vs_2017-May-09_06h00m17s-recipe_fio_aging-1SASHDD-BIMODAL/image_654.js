...
// Set up the chart
var image_654_chart;
$(document).ready(function () {image_654_chart= new Highcharts.Chart({
...
$(image_654_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_654_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_654_chart.options.chart.options3d.alpha,
    beta = image_654_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_654_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_654_chart.options.chart.options3d.alpha = newAlpha;

      image_654_chart.redraw(false);
    },
...
var image_654_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_654_button').click(function () {image_654.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_542_chart;
$(document).ready(function () {image_542_chart= new Highcharts.Chart({
...
$(image_542_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_542_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_542_chart.options.chart.options3d.alpha,
    beta = image_542_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_542_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_542_chart.options.chart.options3d.alpha = newAlpha;

      image_542_chart.redraw(false);
    },
...
var image_542_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_542_button').click(function () {image_542.yAxis[0].update({
            type: types[type]
        });
type += 1;

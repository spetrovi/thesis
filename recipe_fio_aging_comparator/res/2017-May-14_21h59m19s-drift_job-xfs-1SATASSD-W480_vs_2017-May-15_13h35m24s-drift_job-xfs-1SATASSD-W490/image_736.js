...
image_736_chart= new Highcharts.Chart({
...
$(image_736_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_736_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_736_chart.options.chart.options3d.alpha,
    beta = image_736_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_736_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_736_chart.options.chart.options3d.alpha = newAlpha;

      image_736_chart.redraw(false);
    },
...
var image_736_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_736_button').click(function () {image_736.yAxis[0].update({
            type: types[type]
        });
type += 1;

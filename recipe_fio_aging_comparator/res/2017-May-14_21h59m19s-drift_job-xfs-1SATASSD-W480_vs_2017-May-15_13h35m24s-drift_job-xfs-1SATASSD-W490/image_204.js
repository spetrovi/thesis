...
image_204_chart= new Highcharts.Chart({
...
$(image_204_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_204_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_204_chart.options.chart.options3d.alpha,
    beta = image_204_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_204_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_204_chart.options.chart.options3d.alpha = newAlpha;

      image_204_chart.redraw(false);
    },
...
var image_204_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_204_button').click(function () {image_204.yAxis[0].update({
            type: types[type]
        });
type += 1;

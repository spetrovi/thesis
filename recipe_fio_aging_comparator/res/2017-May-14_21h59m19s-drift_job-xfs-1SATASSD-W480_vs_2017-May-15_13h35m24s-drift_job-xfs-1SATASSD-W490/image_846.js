...
image_846_chart= new Highcharts.Chart({
...
$(image_846_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_846_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_846_chart.options.chart.options3d.alpha,
    beta = image_846_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_846_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_846_chart.options.chart.options3d.alpha = newAlpha;

      image_846_chart.redraw(false);
    },
...
var image_846_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_846_button').click(function () {image_846.yAxis[0].update({
            type: types[type]
        });
type += 1;

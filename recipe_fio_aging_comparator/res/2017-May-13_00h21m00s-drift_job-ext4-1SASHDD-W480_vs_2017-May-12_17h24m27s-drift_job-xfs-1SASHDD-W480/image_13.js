...
image_13_chart= new Highcharts.Chart({
...
$(image_13_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_13_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_13_chart.options.chart.options3d.alpha,
    beta = image_13_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_13_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_13_chart.options.chart.options3d.alpha = newAlpha;

      image_13_chart.redraw(false);
    },
...
var image_13_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_13_button').click(function () {image_13.yAxis[0].update({
            type: types[type]
        });
type += 1;

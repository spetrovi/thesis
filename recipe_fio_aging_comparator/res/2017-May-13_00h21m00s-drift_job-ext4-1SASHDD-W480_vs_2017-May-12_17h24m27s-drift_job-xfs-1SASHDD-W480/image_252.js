...
image_252_chart= new Highcharts.Chart({
...
$(image_252_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_252_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_252_chart.options.chart.options3d.alpha,
    beta = image_252_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_252_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_252_chart.options.chart.options3d.alpha = newAlpha;

      image_252_chart.redraw(false);
    },
...
var image_252_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_252_button').click(function () {image_252.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_699_chart;
$(document).ready(function () {image_699_chart= new Highcharts.Chart({
...
$(image_699_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_699_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_699_chart.options.chart.options3d.alpha,
    beta = image_699_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_699_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_699_chart.options.chart.options3d.alpha = newAlpha;

      image_699_chart.redraw(false);
    },
...
var image_699_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_699_button').click(function () {image_699.yAxis[0].update({
            type: types[type]
        });
type += 1;

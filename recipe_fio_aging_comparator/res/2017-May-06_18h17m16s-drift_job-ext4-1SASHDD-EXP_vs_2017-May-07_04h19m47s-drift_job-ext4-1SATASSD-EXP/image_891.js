...
// Set up the chart
var image_891_chart;
$(document).ready(function () {image_891_chart= new Highcharts.Chart({
...
$(image_891_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_891_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_891_chart.options.chart.options3d.alpha,
    beta = image_891_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_891_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_891_chart.options.chart.options3d.alpha = newAlpha;

      image_891_chart.redraw(false);
    },
...
var image_891_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_891_button').click(function () {image_891.yAxis[0].update({
            type: types[type]
        });
type += 1;

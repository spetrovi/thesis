...
// Set up the chart
var image_718_chart;
$(document).ready(function () {image_718_chart= new Highcharts.Chart({
...
$(image_718_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_718_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_718_chart.options.chart.options3d.alpha,
    beta = image_718_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_718_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_718_chart.options.chart.options3d.alpha = newAlpha;

      image_718_chart.redraw(false);
    },
...
var image_718_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_718_button').click(function () {image_718.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_644_chart;
$(document).ready(function () {image_644_chart= new Highcharts.Chart({
...
$(image_644_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_644_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_644_chart.options.chart.options3d.alpha,
    beta = image_644_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_644_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_644_chart.options.chart.options3d.alpha = newAlpha;

      image_644_chart.redraw(false);
    },
...
var image_644_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_644_button').click(function () {image_644.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_637_chart;
$(document).ready(function () {image_637_chart= new Highcharts.Chart({
...
$(image_637_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_637_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_637_chart.options.chart.options3d.alpha,
    beta = image_637_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_637_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_637_chart.options.chart.options3d.alpha = newAlpha;

      image_637_chart.redraw(false);
    },
...
var image_637_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_637_button').click(function () {image_637.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_518_chart;
$(document).ready(function () {image_518_chart= new Highcharts.Chart({
...
$(image_518_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_518_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_518_chart.options.chart.options3d.alpha,
    beta = image_518_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_518_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_518_chart.options.chart.options3d.alpha = newAlpha;

      image_518_chart.redraw(false);
    },
...
var image_518_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_518_button').click(function () {image_518.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_738_chart;
$(document).ready(function () {image_738_chart= new Highcharts.Chart({
...
$(image_738_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_738_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_738_chart.options.chart.options3d.alpha,
    beta = image_738_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_738_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_738_chart.options.chart.options3d.alpha = newAlpha;

      image_738_chart.redraw(false);
    },
...
var image_738_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_738_button').click(function () {image_738.yAxis[0].update({
            type: types[type]
        });
type += 1;

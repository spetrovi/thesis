...
// Set up the chart
var image_315_chart;
$(document).ready(function () {image_315_chart= new Highcharts.Chart({
...
$(image_315_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_315_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_315_chart.options.chart.options3d.alpha,
    beta = image_315_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_315_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_315_chart.options.chart.options3d.alpha = newAlpha;

      image_315_chart.redraw(false);
    },
...
var image_315_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_315_button').click(function () {image_315.yAxis[0].update({
            type: types[type]
        });
type += 1;

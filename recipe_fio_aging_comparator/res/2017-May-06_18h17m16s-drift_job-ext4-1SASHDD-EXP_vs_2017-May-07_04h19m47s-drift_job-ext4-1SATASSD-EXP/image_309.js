...
// Set up the chart
var image_309_chart;
$(document).ready(function () {image_309_chart= new Highcharts.Chart({
...
$(image_309_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_309_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_309_chart.options.chart.options3d.alpha,
    beta = image_309_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_309_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_309_chart.options.chart.options3d.alpha = newAlpha;

      image_309_chart.redraw(false);
    },
...
var image_309_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_309_button').click(function () {image_309.yAxis[0].update({
            type: types[type]
        });
type += 1;

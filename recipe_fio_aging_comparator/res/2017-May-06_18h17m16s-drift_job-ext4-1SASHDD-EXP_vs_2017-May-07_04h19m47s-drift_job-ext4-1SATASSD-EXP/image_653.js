...
// Set up the chart
var image_653_chart;
$(document).ready(function () {image_653_chart= new Highcharts.Chart({
...
$(image_653_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_653_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_653_chart.options.chart.options3d.alpha,
    beta = image_653_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_653_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_653_chart.options.chart.options3d.alpha = newAlpha;

      image_653_chart.redraw(false);
    },
...
var image_653_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_653_button').click(function () {image_653.yAxis[0].update({
            type: types[type]
        });
type += 1;

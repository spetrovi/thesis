...
// Set up the chart
var image_190_chart;
$(document).ready(function () {image_190_chart= new Highcharts.Chart({
...
$(image_190_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_190_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_190_chart.options.chart.options3d.alpha,
    beta = image_190_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_190_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_190_chart.options.chart.options3d.alpha = newAlpha;

      image_190_chart.redraw(false);
    },
...
var image_190_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_190_button').click(function () {image_190.yAxis[0].update({
            type: types[type]
        });
type += 1;

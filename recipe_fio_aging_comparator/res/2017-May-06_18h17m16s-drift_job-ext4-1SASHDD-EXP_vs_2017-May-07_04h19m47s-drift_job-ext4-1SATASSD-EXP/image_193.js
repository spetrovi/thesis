...
// Set up the chart
var image_193_chart;
$(document).ready(function () {image_193_chart= new Highcharts.Chart({
...
$(image_193_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_193_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_193_chart.options.chart.options3d.alpha,
    beta = image_193_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_193_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_193_chart.options.chart.options3d.alpha = newAlpha;

      image_193_chart.redraw(false);
    },
...
var image_193_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_193_button').click(function () {image_193.yAxis[0].update({
            type: types[type]
        });
type += 1;

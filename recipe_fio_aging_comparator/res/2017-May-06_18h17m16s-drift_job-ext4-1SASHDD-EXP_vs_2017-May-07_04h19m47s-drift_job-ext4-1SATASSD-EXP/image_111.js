...
// Set up the chart
var image_111_chart;
$(document).ready(function () {image_111_chart= new Highcharts.Chart({
...
$(image_111_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_111_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_111_chart.options.chart.options3d.alpha,
    beta = image_111_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_111_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_111_chart.options.chart.options3d.alpha = newAlpha;

      image_111_chart.redraw(false);
    },
...
var image_111_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_111_button').click(function () {image_111.yAxis[0].update({
            type: types[type]
        });
type += 1;

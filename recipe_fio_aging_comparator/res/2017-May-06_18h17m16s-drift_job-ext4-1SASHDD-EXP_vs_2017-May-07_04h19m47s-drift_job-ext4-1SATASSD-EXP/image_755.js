...
// Set up the chart
var image_755_chart;
$(document).ready(function () {image_755_chart= new Highcharts.Chart({
...
$(image_755_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_755_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_755_chart.options.chart.options3d.alpha,
    beta = image_755_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_755_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_755_chart.options.chart.options3d.alpha = newAlpha;

      image_755_chart.redraw(false);
    },
...
var image_755_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_755_button').click(function () {image_755.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_42_chart;
$(document).ready(function () {image_42_chart= new Highcharts.Chart({
...
$(image_42_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_42_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_42_chart.options.chart.options3d.alpha,
    beta = image_42_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_42_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_42_chart.options.chart.options3d.alpha = newAlpha;

      image_42_chart.redraw(false);
    },
...
var image_42_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_42_button').click(function () {image_42.yAxis[0].update({
            type: types[type]
        });
type += 1;

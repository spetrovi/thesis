...
// Set up the chart
var image_173_chart;
$(document).ready(function () {image_173_chart= new Highcharts.Chart({
...
$(image_173_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_173_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_173_chart.options.chart.options3d.alpha,
    beta = image_173_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_173_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_173_chart.options.chart.options3d.alpha = newAlpha;

      image_173_chart.redraw(false);
    },
...
var image_173_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_173_button').click(function () {image_173.yAxis[0].update({
            type: types[type]
        });
type += 1;

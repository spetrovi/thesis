...
// Set up the chart
var image_862_chart;
$(document).ready(function () {image_862_chart= new Highcharts.Chart({
...
$(image_862_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_862_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_862_chart.options.chart.options3d.alpha,
    beta = image_862_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_862_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_862_chart.options.chart.options3d.alpha = newAlpha;

      image_862_chart.redraw(false);
    },
...
var image_862_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_862_button').click(function () {image_862.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_289_chart;
$(document).ready(function () {image_289_chart= new Highcharts.Chart({
...
$(image_289_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_289_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_289_chart.options.chart.options3d.alpha,
    beta = image_289_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_289_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_289_chart.options.chart.options3d.alpha = newAlpha;

      image_289_chart.redraw(false);
    },
...
var image_289_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_289_button').click(function () {image_289.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_274_chart;
$(document).ready(function () {image_274_chart= new Highcharts.Chart({
...
$(image_274_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_274_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_274_chart.options.chart.options3d.alpha,
    beta = image_274_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_274_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_274_chart.options.chart.options3d.alpha = newAlpha;

      image_274_chart.redraw(false);
    },
...
var image_274_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_274_button').click(function () {image_274.yAxis[0].update({
            type: types[type]
        });
type += 1;

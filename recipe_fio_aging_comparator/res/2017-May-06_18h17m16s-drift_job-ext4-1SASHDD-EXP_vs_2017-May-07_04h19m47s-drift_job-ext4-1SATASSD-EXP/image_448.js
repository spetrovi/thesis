...
// Set up the chart
var image_448_chart;
$(document).ready(function () {image_448_chart= new Highcharts.Chart({
...
$(image_448_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_448_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_448_chart.options.chart.options3d.alpha,
    beta = image_448_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_448_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_448_chart.options.chart.options3d.alpha = newAlpha;

      image_448_chart.redraw(false);
    },
...
var image_448_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_448_button').click(function () {image_448.yAxis[0].update({
            type: types[type]
        });
type += 1;

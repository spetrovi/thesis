...
// Set up the chart
var image_959_chart;
$(document).ready(function () {image_959_chart= new Highcharts.Chart({
...
$(image_959_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_959_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_959_chart.options.chart.options3d.alpha,
    beta = image_959_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_959_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_959_chart.options.chart.options3d.alpha = newAlpha;

      image_959_chart.redraw(false);
    },
...
var image_959_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_959_button').click(function () {image_959.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_305_chart;
$(document).ready(function () {image_305_chart= new Highcharts.Chart({
...
$(image_305_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_305_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_305_chart.options.chart.options3d.alpha,
    beta = image_305_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_305_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_305_chart.options.chart.options3d.alpha = newAlpha;

      image_305_chart.redraw(false);
    },
...
var image_305_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_305_button').click(function () {image_305.yAxis[0].update({
            type: types[type]
        });
type += 1;

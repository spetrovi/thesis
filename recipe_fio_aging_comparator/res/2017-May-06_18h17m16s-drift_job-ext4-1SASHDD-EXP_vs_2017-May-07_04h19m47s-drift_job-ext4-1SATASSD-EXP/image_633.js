...
// Set up the chart
var image_633_chart;
$(document).ready(function () {image_633_chart= new Highcharts.Chart({
...
$(image_633_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_633_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_633_chart.options.chart.options3d.alpha,
    beta = image_633_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_633_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_633_chart.options.chart.options3d.alpha = newAlpha;

      image_633_chart.redraw(false);
    },
...
var image_633_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_633_button').click(function () {image_633.yAxis[0].update({
            type: types[type]
        });
type += 1;

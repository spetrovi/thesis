...
// Set up the chart
var image_287_chart;
$(document).ready(function () {image_287_chart= new Highcharts.Chart({
...
$(image_287_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_287_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_287_chart.options.chart.options3d.alpha,
    beta = image_287_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_287_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_287_chart.options.chart.options3d.alpha = newAlpha;

      image_287_chart.redraw(false);
    },
...
var image_287_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_287_button').click(function () {image_287.yAxis[0].update({
            type: types[type]
        });
type += 1;

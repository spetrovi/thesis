...
// Set up the chart
var image_264_chart;
$(document).ready(function () {image_264_chart= new Highcharts.Chart({
...
$(image_264_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_264_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_264_chart.options.chart.options3d.alpha,
    beta = image_264_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_264_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_264_chart.options.chart.options3d.alpha = newAlpha;

      image_264_chart.redraw(false);
    },
...
var image_264_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_264_button').click(function () {image_264.yAxis[0].update({
            type: types[type]
        });
type += 1;

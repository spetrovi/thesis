...
// Set up the chart
var image_397_chart;
$(document).ready(function () {image_397_chart= new Highcharts.Chart({
...
$(image_397_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_397_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_397_chart.options.chart.options3d.alpha,
    beta = image_397_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_397_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_397_chart.options.chart.options3d.alpha = newAlpha;

      image_397_chart.redraw(false);
    },
...
var image_397_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_397_button').click(function () {image_397.yAxis[0].update({
            type: types[type]
        });
type += 1;

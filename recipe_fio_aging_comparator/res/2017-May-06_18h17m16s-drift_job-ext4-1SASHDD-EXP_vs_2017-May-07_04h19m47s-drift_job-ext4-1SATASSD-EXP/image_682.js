...
// Set up the chart
var image_682_chart;
$(document).ready(function () {image_682_chart= new Highcharts.Chart({
...
$(image_682_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_682_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_682_chart.options.chart.options3d.alpha,
    beta = image_682_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_682_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_682_chart.options.chart.options3d.alpha = newAlpha;

      image_682_chart.redraw(false);
    },
...
var image_682_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_682_button').click(function () {image_682.yAxis[0].update({
            type: types[type]
        });
type += 1;

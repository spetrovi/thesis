...
// Set up the chart
var image_260_chart;
$(document).ready(function () {image_260_chart= new Highcharts.Chart({
...
$(image_260_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_260_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_260_chart.options.chart.options3d.alpha,
    beta = image_260_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_260_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_260_chart.options.chart.options3d.alpha = newAlpha;

      image_260_chart.redraw(false);
    },
...
var image_260_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_260_button').click(function () {image_260.yAxis[0].update({
            type: types[type]
        });
type += 1;

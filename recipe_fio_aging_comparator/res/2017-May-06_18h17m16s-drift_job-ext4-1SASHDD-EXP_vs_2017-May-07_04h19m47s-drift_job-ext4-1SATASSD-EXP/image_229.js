...
// Set up the chart
var image_229_chart;
$(document).ready(function () {image_229_chart= new Highcharts.Chart({
...
$(image_229_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_229_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_229_chart.options.chart.options3d.alpha,
    beta = image_229_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_229_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_229_chart.options.chart.options3d.alpha = newAlpha;

      image_229_chart.redraw(false);
    },
...
var image_229_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_229_button').click(function () {image_229.yAxis[0].update({
            type: types[type]
        });
type += 1;

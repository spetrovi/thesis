...
// Set up the chart
var image_443_chart;
$(document).ready(function () {image_443_chart= new Highcharts.Chart({
...
$(image_443_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_443_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_443_chart.options.chart.options3d.alpha,
    beta = image_443_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_443_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_443_chart.options.chart.options3d.alpha = newAlpha;

      image_443_chart.redraw(false);
    },
...
var image_443_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_443_button').click(function () {image_443.yAxis[0].update({
            type: types[type]
        });
type += 1;

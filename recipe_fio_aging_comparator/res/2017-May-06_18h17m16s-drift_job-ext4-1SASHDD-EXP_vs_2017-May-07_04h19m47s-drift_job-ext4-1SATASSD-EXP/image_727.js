...
// Set up the chart
var image_727_chart;
$(document).ready(function () {image_727_chart= new Highcharts.Chart({
...
$(image_727_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_727_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_727_chart.options.chart.options3d.alpha,
    beta = image_727_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_727_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_727_chart.options.chart.options3d.alpha = newAlpha;

      image_727_chart.redraw(false);
    },
...
var image_727_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_727_button').click(function () {image_727.yAxis[0].update({
            type: types[type]
        });
type += 1;

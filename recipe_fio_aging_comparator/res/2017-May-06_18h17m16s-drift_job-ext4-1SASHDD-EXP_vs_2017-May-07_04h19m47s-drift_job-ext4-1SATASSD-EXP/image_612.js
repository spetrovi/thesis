...
// Set up the chart
var image_612_chart;
$(document).ready(function () {image_612_chart= new Highcharts.Chart({
...
$(image_612_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_612_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_612_chart.options.chart.options3d.alpha,
    beta = image_612_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_612_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_612_chart.options.chart.options3d.alpha = newAlpha;

      image_612_chart.redraw(false);
    },
...
var image_612_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_612_button').click(function () {image_612.yAxis[0].update({
            type: types[type]
        });
type += 1;

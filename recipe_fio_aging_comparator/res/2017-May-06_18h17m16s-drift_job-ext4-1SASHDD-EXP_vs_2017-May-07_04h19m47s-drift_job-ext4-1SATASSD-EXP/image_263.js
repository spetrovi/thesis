...
// Set up the chart
var image_263_chart;
$(document).ready(function () {image_263_chart= new Highcharts.Chart({
...
$(image_263_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_263_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_263_chart.options.chart.options3d.alpha,
    beta = image_263_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_263_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_263_chart.options.chart.options3d.alpha = newAlpha;

      image_263_chart.redraw(false);
    },
...
var image_263_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_263_button').click(function () {image_263.yAxis[0].update({
            type: types[type]
        });
type += 1;

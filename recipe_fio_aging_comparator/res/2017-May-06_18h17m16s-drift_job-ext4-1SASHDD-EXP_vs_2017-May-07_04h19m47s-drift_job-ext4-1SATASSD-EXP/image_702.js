...
// Set up the chart
var image_702_chart;
$(document).ready(function () {image_702_chart= new Highcharts.Chart({
...
$(image_702_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_702_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_702_chart.options.chart.options3d.alpha,
    beta = image_702_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_702_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_702_chart.options.chart.options3d.alpha = newAlpha;

      image_702_chart.redraw(false);
    },
...
var image_702_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_702_button').click(function () {image_702.yAxis[0].update({
            type: types[type]
        });
type += 1;

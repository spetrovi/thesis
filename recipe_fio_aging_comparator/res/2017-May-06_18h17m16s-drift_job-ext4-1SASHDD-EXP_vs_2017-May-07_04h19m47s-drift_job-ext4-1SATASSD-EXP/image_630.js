...
// Set up the chart
var image_630_chart;
$(document).ready(function () {image_630_chart= new Highcharts.Chart({
...
$(image_630_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_630_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_630_chart.options.chart.options3d.alpha,
    beta = image_630_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_630_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_630_chart.options.chart.options3d.alpha = newAlpha;

      image_630_chart.redraw(false);
    },
...
var image_630_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_630_button').click(function () {image_630.yAxis[0].update({
            type: types[type]
        });
type += 1;

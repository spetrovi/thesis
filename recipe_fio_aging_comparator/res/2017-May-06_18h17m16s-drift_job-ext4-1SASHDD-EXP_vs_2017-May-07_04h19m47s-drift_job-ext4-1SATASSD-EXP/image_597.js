...
// Set up the chart
var image_597_chart;
$(document).ready(function () {image_597_chart= new Highcharts.Chart({
...
$(image_597_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_597_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_597_chart.options.chart.options3d.alpha,
    beta = image_597_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_597_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_597_chart.options.chart.options3d.alpha = newAlpha;

      image_597_chart.redraw(false);
    },
...
var image_597_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_597_button').click(function () {image_597.yAxis[0].update({
            type: types[type]
        });
type += 1;

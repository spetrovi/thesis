...
// Set up the chart
var image_231_chart;
$(document).ready(function () {image_231_chart= new Highcharts.Chart({
...
$(image_231_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_231_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_231_chart.options.chart.options3d.alpha,
    beta = image_231_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_231_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_231_chart.options.chart.options3d.alpha = newAlpha;

      image_231_chart.redraw(false);
    },
...
var image_231_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_231_button').click(function () {image_231.yAxis[0].update({
            type: types[type]
        });
type += 1;

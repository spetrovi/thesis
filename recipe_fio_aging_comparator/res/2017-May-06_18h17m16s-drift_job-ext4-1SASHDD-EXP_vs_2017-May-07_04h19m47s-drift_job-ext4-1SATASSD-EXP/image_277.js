...
// Set up the chart
var image_277_chart;
$(document).ready(function () {image_277_chart= new Highcharts.Chart({
...
$(image_277_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_277_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_277_chart.options.chart.options3d.alpha,
    beta = image_277_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_277_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_277_chart.options.chart.options3d.alpha = newAlpha;

      image_277_chart.redraw(false);
    },
...
var image_277_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_277_button').click(function () {image_277.yAxis[0].update({
            type: types[type]
        });
type += 1;

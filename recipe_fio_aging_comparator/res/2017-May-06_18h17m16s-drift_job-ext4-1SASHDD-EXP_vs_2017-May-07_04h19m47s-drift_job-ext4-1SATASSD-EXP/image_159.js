...
// Set up the chart
var image_159_chart;
$(document).ready(function () {image_159_chart= new Highcharts.Chart({
...
$(image_159_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_159_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_159_chart.options.chart.options3d.alpha,
    beta = image_159_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_159_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_159_chart.options.chart.options3d.alpha = newAlpha;

      image_159_chart.redraw(false);
    },
...
var image_159_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_159_button').click(function () {image_159.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_214_chart;
$(document).ready(function () {image_214_chart= new Highcharts.Chart({
...
$(image_214_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_214_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_214_chart.options.chart.options3d.alpha,
    beta = image_214_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_214_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_214_chart.options.chart.options3d.alpha = newAlpha;

      image_214_chart.redraw(false);
    },
...
var image_214_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_214_button').click(function () {image_214.yAxis[0].update({
            type: types[type]
        });
type += 1;

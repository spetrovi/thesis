...
// Set up the chart
var image_492_chart;
$(document).ready(function () {image_492_chart= new Highcharts.Chart({
...
$(image_492_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_492_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_492_chart.options.chart.options3d.alpha,
    beta = image_492_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_492_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_492_chart.options.chart.options3d.alpha = newAlpha;

      image_492_chart.redraw(false);
    },
...
var image_492_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_492_button').click(function () {image_492.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_790_chart;
$(document).ready(function () {image_790_chart= new Highcharts.Chart({
...
$(image_790_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_790_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_790_chart.options.chart.options3d.alpha,
    beta = image_790_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_790_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_790_chart.options.chart.options3d.alpha = newAlpha;

      image_790_chart.redraw(false);
    },
...
var image_790_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_790_button').click(function () {image_790.yAxis[0].update({
            type: types[type]
        });
type += 1;

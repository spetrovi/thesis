...
// Set up the chart
var image_561_chart;
$(document).ready(function () {image_561_chart= new Highcharts.Chart({
...
$(image_561_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_561_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_561_chart.options.chart.options3d.alpha,
    beta = image_561_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_561_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_561_chart.options.chart.options3d.alpha = newAlpha;

      image_561_chart.redraw(false);
    },
...
var image_561_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_561_button').click(function () {image_561.yAxis[0].update({
            type: types[type]
        });
type += 1;

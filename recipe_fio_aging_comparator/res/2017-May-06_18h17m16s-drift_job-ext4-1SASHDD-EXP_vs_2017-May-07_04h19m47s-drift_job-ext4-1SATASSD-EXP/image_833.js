...
// Set up the chart
var image_833_chart;
$(document).ready(function () {image_833_chart= new Highcharts.Chart({
...
$(image_833_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_833_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_833_chart.options.chart.options3d.alpha,
    beta = image_833_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_833_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_833_chart.options.chart.options3d.alpha = newAlpha;

      image_833_chart.redraw(false);
    },
...
var image_833_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_833_button').click(function () {image_833.yAxis[0].update({
            type: types[type]
        });
type += 1;

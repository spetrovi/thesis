...
// Set up the chart
var image_789_chart;
$(document).ready(function () {image_789_chart= new Highcharts.Chart({
...
$(image_789_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_789_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_789_chart.options.chart.options3d.alpha,
    beta = image_789_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_789_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_789_chart.options.chart.options3d.alpha = newAlpha;

      image_789_chart.redraw(false);
    },
...
var image_789_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_789_button').click(function () {image_789.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_233_chart;
$(document).ready(function () {image_233_chart= new Highcharts.Chart({
...
$(image_233_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_233_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_233_chart.options.chart.options3d.alpha,
    beta = image_233_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_233_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_233_chart.options.chart.options3d.alpha = newAlpha;

      image_233_chart.redraw(false);
    },
...
var image_233_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_233_button').click(function () {image_233.yAxis[0].update({
            type: types[type]
        });
type += 1;

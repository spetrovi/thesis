...
// Set up the chart
var image_269_chart;
$(document).ready(function () {image_269_chart= new Highcharts.Chart({
...
$(image_269_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_269_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_269_chart.options.chart.options3d.alpha,
    beta = image_269_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_269_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_269_chart.options.chart.options3d.alpha = newAlpha;

      image_269_chart.redraw(false);
    },
...
var image_269_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_269_button').click(function () {image_269.yAxis[0].update({
            type: types[type]
        });
type += 1;

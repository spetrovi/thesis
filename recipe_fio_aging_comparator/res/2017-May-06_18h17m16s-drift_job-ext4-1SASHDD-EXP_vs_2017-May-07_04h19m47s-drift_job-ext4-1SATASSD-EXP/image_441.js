...
// Set up the chart
var image_441_chart;
$(document).ready(function () {image_441_chart= new Highcharts.Chart({
...
$(image_441_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_441_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_441_chart.options.chart.options3d.alpha,
    beta = image_441_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_441_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_441_chart.options.chart.options3d.alpha = newAlpha;

      image_441_chart.redraw(false);
    },
...
var image_441_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_441_button').click(function () {image_441.yAxis[0].update({
            type: types[type]
        });
type += 1;

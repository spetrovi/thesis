...
// Set up the chart
var image_428_chart;
$(document).ready(function () {image_428_chart= new Highcharts.Chart({
...
$(image_428_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_428_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_428_chart.options.chart.options3d.alpha,
    beta = image_428_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_428_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_428_chart.options.chart.options3d.alpha = newAlpha;

      image_428_chart.redraw(false);
    },
...
var image_428_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_428_button').click(function () {image_428.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_588_chart;
$(document).ready(function () {image_588_chart= new Highcharts.Chart({
...
$(image_588_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_588_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_588_chart.options.chart.options3d.alpha,
    beta = image_588_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_588_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_588_chart.options.chart.options3d.alpha = newAlpha;

      image_588_chart.redraw(false);
    },
...
var image_588_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_588_button').click(function () {image_588.yAxis[0].update({
            type: types[type]
        });
type += 1;

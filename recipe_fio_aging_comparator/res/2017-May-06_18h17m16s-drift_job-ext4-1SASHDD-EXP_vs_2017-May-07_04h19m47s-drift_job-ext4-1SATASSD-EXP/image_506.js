...
// Set up the chart
var image_506_chart;
$(document).ready(function () {image_506_chart= new Highcharts.Chart({
...
$(image_506_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_506_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_506_chart.options.chart.options3d.alpha,
    beta = image_506_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_506_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_506_chart.options.chart.options3d.alpha = newAlpha;

      image_506_chart.redraw(false);
    },
...
var image_506_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_506_button').click(function () {image_506.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_692_chart;
$(document).ready(function () {image_692_chart= new Highcharts.Chart({
...
$(image_692_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_692_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_692_chart.options.chart.options3d.alpha,
    beta = image_692_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_692_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_692_chart.options.chart.options3d.alpha = newAlpha;

      image_692_chart.redraw(false);
    },
...
var image_692_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_692_button').click(function () {image_692.yAxis[0].update({
            type: types[type]
        });
type += 1;

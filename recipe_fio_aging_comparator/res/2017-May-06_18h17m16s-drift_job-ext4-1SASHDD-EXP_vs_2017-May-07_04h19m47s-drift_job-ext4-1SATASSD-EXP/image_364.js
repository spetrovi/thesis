...
// Set up the chart
var image_364_chart;
$(document).ready(function () {image_364_chart= new Highcharts.Chart({
...
$(image_364_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_364_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_364_chart.options.chart.options3d.alpha,
    beta = image_364_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_364_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_364_chart.options.chart.options3d.alpha = newAlpha;

      image_364_chart.redraw(false);
    },
...
var image_364_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_364_button').click(function () {image_364.yAxis[0].update({
            type: types[type]
        });
type += 1;

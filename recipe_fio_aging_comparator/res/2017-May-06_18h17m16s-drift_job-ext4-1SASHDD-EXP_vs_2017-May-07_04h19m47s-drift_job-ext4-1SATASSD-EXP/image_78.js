...
// Set up the chart
var image_78_chart;
$(document).ready(function () {image_78_chart= new Highcharts.Chart({
...
$(image_78_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_78_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_78_chart.options.chart.options3d.alpha,
    beta = image_78_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_78_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_78_chart.options.chart.options3d.alpha = newAlpha;

      image_78_chart.redraw(false);
    },
...
var image_78_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_78_button').click(function () {image_78.yAxis[0].update({
            type: types[type]
        });
type += 1;

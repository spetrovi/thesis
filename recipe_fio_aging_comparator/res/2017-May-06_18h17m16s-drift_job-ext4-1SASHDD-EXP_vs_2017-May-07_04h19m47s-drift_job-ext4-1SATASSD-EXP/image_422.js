...
// Set up the chart
var image_422_chart;
$(document).ready(function () {image_422_chart= new Highcharts.Chart({
...
$(image_422_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_422_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_422_chart.options.chart.options3d.alpha,
    beta = image_422_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_422_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_422_chart.options.chart.options3d.alpha = newAlpha;

      image_422_chart.redraw(false);
    },
...
var image_422_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_422_button').click(function () {image_422.yAxis[0].update({
            type: types[type]
        });
type += 1;

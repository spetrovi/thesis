...
// Set up the chart
var image_398_chart;
$(document).ready(function () {image_398_chart= new Highcharts.Chart({
...
$(image_398_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_398_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_398_chart.options.chart.options3d.alpha,
    beta = image_398_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_398_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_398_chart.options.chart.options3d.alpha = newAlpha;

      image_398_chart.redraw(false);
    },
...
var image_398_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_398_button').click(function () {image_398.yAxis[0].update({
            type: types[type]
        });
type += 1;

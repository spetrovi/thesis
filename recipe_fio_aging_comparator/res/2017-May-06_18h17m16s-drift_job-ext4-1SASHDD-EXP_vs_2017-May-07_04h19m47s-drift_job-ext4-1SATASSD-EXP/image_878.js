...
// Set up the chart
var image_878_chart;
$(document).ready(function () {image_878_chart= new Highcharts.Chart({
...
$(image_878_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_878_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_878_chart.options.chart.options3d.alpha,
    beta = image_878_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_878_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_878_chart.options.chart.options3d.alpha = newAlpha;

      image_878_chart.redraw(false);
    },
...
var image_878_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_878_button').click(function () {image_878.yAxis[0].update({
            type: types[type]
        });
type += 1;

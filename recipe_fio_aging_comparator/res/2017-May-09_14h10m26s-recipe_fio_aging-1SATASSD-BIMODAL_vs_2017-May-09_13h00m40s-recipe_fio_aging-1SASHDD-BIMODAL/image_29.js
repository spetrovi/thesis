...
// Set up the chart
var image_29_chart;
$(document).ready(function () {image_29_chart= new Highcharts.Chart({
...
$(image_29_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_29_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_29_chart.options.chart.options3d.alpha,
    beta = image_29_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_29_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_29_chart.options.chart.options3d.alpha = newAlpha;

      image_29_chart.redraw(false);
    },
...
var image_29_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_29_button').click(function () {image_29.yAxis[0].update({
            type: types[type]
        });
type += 1;

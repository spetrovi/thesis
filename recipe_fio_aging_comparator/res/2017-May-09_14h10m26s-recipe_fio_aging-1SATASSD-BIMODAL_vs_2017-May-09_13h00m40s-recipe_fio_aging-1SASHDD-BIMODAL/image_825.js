...
// Set up the chart
var image_825_chart;
$(document).ready(function () {image_825_chart= new Highcharts.Chart({
...
$(image_825_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_825_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_825_chart.options.chart.options3d.alpha,
    beta = image_825_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_825_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_825_chart.options.chart.options3d.alpha = newAlpha;

      image_825_chart.redraw(false);
    },
...
var image_825_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_825_button').click(function () {image_825.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_849_chart;
$(document).ready(function () {image_849_chart= new Highcharts.Chart({
...
$(image_849_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_849_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_849_chart.options.chart.options3d.alpha,
    beta = image_849_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_849_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_849_chart.options.chart.options3d.alpha = newAlpha;

      image_849_chart.redraw(false);
    },
...
var image_849_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_849_button').click(function () {image_849.yAxis[0].update({
            type: types[type]
        });
type += 1;

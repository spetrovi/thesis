...
// Set up the chart
var image_838_chart;
$(document).ready(function () {image_838_chart= new Highcharts.Chart({
...
$(image_838_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_838_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_838_chart.options.chart.options3d.alpha,
    beta = image_838_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_838_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_838_chart.options.chart.options3d.alpha = newAlpha;

      image_838_chart.redraw(false);
    },
...
var image_838_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_838_button').click(function () {image_838.yAxis[0].update({
            type: types[type]
        });
type += 1;

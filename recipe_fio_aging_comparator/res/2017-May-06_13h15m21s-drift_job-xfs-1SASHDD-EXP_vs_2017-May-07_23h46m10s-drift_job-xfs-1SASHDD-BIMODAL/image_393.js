...
// Set up the chart
var image_393_chart;
$(document).ready(function () {image_393_chart= new Highcharts.Chart({
...
$(image_393_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_393_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_393_chart.options.chart.options3d.alpha,
    beta = image_393_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_393_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_393_chart.options.chart.options3d.alpha = newAlpha;

      image_393_chart.redraw(false);
    },
...
var image_393_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_393_button').click(function () {image_393.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_337_chart;
$(document).ready(function () {image_337_chart= new Highcharts.Chart({
...
$(image_337_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_337_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_337_chart.options.chart.options3d.alpha,
    beta = image_337_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_337_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_337_chart.options.chart.options3d.alpha = newAlpha;

      image_337_chart.redraw(false);
    },
...
var image_337_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_337_button').click(function () {image_337.yAxis[0].update({
            type: types[type]
        });
type += 1;

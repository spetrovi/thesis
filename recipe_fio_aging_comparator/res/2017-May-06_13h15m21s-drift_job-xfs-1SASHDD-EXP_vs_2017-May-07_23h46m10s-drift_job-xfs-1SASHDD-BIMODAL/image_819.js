...
// Set up the chart
var image_819_chart;
$(document).ready(function () {image_819_chart= new Highcharts.Chart({
...
$(image_819_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_819_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_819_chart.options.chart.options3d.alpha,
    beta = image_819_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_819_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_819_chart.options.chart.options3d.alpha = newAlpha;

      image_819_chart.redraw(false);
    },
...
var image_819_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_819_button').click(function () {image_819.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_572_chart;
$(document).ready(function () {image_572_chart= new Highcharts.Chart({
...
$(image_572_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_572_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_572_chart.options.chart.options3d.alpha,
    beta = image_572_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_572_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_572_chart.options.chart.options3d.alpha = newAlpha;

      image_572_chart.redraw(false);
    },
...
var image_572_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_572_button').click(function () {image_572.yAxis[0].update({
            type: types[type]
        });
type += 1;

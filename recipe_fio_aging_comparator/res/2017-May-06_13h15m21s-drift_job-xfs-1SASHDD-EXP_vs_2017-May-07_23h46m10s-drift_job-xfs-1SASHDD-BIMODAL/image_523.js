...
// Set up the chart
var image_523_chart;
$(document).ready(function () {image_523_chart= new Highcharts.Chart({
...
$(image_523_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_523_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_523_chart.options.chart.options3d.alpha,
    beta = image_523_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_523_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_523_chart.options.chart.options3d.alpha = newAlpha;

      image_523_chart.redraw(false);
    },
...
var image_523_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_523_button').click(function () {image_523.yAxis[0].update({
            type: types[type]
        });
type += 1;

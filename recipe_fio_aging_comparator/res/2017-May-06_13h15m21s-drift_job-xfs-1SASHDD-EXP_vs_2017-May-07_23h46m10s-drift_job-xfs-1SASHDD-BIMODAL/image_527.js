...
// Set up the chart
var image_527_chart;
$(document).ready(function () {image_527_chart= new Highcharts.Chart({
...
$(image_527_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_527_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_527_chart.options.chart.options3d.alpha,
    beta = image_527_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_527_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_527_chart.options.chart.options3d.alpha = newAlpha;

      image_527_chart.redraw(false);
    },
...
var image_527_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_527_button').click(function () {image_527.yAxis[0].update({
            type: types[type]
        });
type += 1;

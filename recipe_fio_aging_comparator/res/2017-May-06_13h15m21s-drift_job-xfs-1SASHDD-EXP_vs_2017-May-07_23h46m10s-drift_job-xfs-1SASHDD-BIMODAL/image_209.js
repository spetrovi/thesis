...
// Set up the chart
var image_209_chart;
$(document).ready(function () {image_209_chart= new Highcharts.Chart({
...
$(image_209_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_209_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_209_chart.options.chart.options3d.alpha,
    beta = image_209_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_209_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_209_chart.options.chart.options3d.alpha = newAlpha;

      image_209_chart.redraw(false);
    },
...
var image_209_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_209_button').click(function () {image_209.yAxis[0].update({
            type: types[type]
        });
type += 1;

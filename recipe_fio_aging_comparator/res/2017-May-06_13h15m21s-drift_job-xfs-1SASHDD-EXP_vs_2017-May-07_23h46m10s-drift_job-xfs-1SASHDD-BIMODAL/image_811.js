...
// Set up the chart
var image_811_chart;
$(document).ready(function () {image_811_chart= new Highcharts.Chart({
...
$(image_811_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_811_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_811_chart.options.chart.options3d.alpha,
    beta = image_811_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_811_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_811_chart.options.chart.options3d.alpha = newAlpha;

      image_811_chart.redraw(false);
    },
...
var image_811_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_811_button').click(function () {image_811.yAxis[0].update({
            type: types[type]
        });
type += 1;

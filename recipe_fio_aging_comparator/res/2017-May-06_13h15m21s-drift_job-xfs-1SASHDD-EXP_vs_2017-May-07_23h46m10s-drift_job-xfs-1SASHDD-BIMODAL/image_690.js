...
// Set up the chart
var image_690_chart;
$(document).ready(function () {image_690_chart= new Highcharts.Chart({
...
$(image_690_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_690_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_690_chart.options.chart.options3d.alpha,
    beta = image_690_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_690_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_690_chart.options.chart.options3d.alpha = newAlpha;

      image_690_chart.redraw(false);
    },
...
var image_690_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_690_button').click(function () {image_690.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_629_chart;
$(document).ready(function () {image_629_chart= new Highcharts.Chart({
...
$(image_629_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_629_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_629_chart.options.chart.options3d.alpha,
    beta = image_629_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_629_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_629_chart.options.chart.options3d.alpha = newAlpha;

      image_629_chart.redraw(false);
    },
...
var image_629_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_629_button').click(function () {image_629.yAxis[0].update({
            type: types[type]
        });
type += 1;

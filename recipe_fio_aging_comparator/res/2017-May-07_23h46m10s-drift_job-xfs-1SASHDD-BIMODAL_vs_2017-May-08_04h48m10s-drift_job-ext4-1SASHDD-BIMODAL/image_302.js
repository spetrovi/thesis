...
// Set up the chart
var image_302_chart;
$(document).ready(function () {image_302_chart= new Highcharts.Chart({
...
$(image_302_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_302_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_302_chart.options.chart.options3d.alpha,
    beta = image_302_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_302_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_302_chart.options.chart.options3d.alpha = newAlpha;

      image_302_chart.redraw(false);
    },
...
var image_302_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_302_button').click(function () {image_302.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_924_chart;
$(document).ready(function () {image_924_chart= new Highcharts.Chart({
...
$(image_924_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_924_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_924_chart.options.chart.options3d.alpha,
    beta = image_924_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_924_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_924_chart.options.chart.options3d.alpha = newAlpha;

      image_924_chart.redraw(false);
    },
...
var image_924_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_924_button').click(function () {image_924.yAxis[0].update({
            type: types[type]
        });
type += 1;

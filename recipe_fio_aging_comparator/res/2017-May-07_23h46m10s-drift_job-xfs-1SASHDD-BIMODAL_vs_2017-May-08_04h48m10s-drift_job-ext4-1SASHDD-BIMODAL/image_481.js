...
// Set up the chart
var image_481_chart;
$(document).ready(function () {image_481_chart= new Highcharts.Chart({
...
$(image_481_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_481_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_481_chart.options.chart.options3d.alpha,
    beta = image_481_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_481_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_481_chart.options.chart.options3d.alpha = newAlpha;

      image_481_chart.redraw(false);
    },
...
var image_481_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_481_button').click(function () {image_481.yAxis[0].update({
            type: types[type]
        });
type += 1;

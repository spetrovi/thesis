...
// Set up the chart
var image_547_chart;
$(document).ready(function () {image_547_chart= new Highcharts.Chart({
...
$(image_547_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_547_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_547_chart.options.chart.options3d.alpha,
    beta = image_547_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_547_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_547_chart.options.chart.options3d.alpha = newAlpha;

      image_547_chart.redraw(false);
    },
...
var image_547_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_547_button').click(function () {image_547.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_913_chart;
$(document).ready(function () {image_913_chart= new Highcharts.Chart({
...
$(image_913_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_913_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_913_chart.options.chart.options3d.alpha,
    beta = image_913_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_913_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_913_chart.options.chart.options3d.alpha = newAlpha;

      image_913_chart.redraw(false);
    },
...
var image_913_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_913_button').click(function () {image_913.yAxis[0].update({
            type: types[type]
        });
type += 1;

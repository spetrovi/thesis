...
// Set up the chart
var image_550_chart;
$(document).ready(function () {image_550_chart= new Highcharts.Chart({
...
$(image_550_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_550_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_550_chart.options.chart.options3d.alpha,
    beta = image_550_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_550_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_550_chart.options.chart.options3d.alpha = newAlpha;

      image_550_chart.redraw(false);
    },
...
var image_550_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_550_button').click(function () {image_550.yAxis[0].update({
            type: types[type]
        });
type += 1;

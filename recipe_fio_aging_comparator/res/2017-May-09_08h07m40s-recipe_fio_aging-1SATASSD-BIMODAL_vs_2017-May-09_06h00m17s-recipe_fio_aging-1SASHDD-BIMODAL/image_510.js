...
// Set up the chart
var image_510_chart;
$(document).ready(function () {image_510_chart= new Highcharts.Chart({
...
$(image_510_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_510_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_510_chart.options.chart.options3d.alpha,
    beta = image_510_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_510_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_510_chart.options.chart.options3d.alpha = newAlpha;

      image_510_chart.redraw(false);
    },
...
var image_510_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_510_button').click(function () {image_510.yAxis[0].update({
            type: types[type]
        });
type += 1;

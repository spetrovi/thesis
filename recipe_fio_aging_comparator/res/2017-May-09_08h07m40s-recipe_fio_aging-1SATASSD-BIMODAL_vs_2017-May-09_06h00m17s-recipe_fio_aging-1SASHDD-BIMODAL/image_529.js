...
// Set up the chart
var image_529_chart;
$(document).ready(function () {image_529_chart= new Highcharts.Chart({
...
$(image_529_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_529_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_529_chart.options.chart.options3d.alpha,
    beta = image_529_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_529_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_529_chart.options.chart.options3d.alpha = newAlpha;

      image_529_chart.redraw(false);
    },
...
var image_529_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_529_button').click(function () {image_529.yAxis[0].update({
            type: types[type]
        });
type += 1;

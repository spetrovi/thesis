...
// Set up the chart
var image_341_chart;
$(document).ready(function () {image_341_chart= new Highcharts.Chart({
...
$(image_341_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_341_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_341_chart.options.chart.options3d.alpha,
    beta = image_341_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_341_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_341_chart.options.chart.options3d.alpha = newAlpha;

      image_341_chart.redraw(false);
    },
...
var image_341_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_341_button').click(function () {image_341.yAxis[0].update({
            type: types[type]
        });
type += 1;

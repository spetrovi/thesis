...
// Set up the chart
var image_530_chart;
$(document).ready(function () {image_530_chart= new Highcharts.Chart({
...
$(image_530_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_530_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_530_chart.options.chart.options3d.alpha,
    beta = image_530_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_530_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_530_chart.options.chart.options3d.alpha = newAlpha;

      image_530_chart.redraw(false);
    },
...
var image_530_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_530_button').click(function () {image_530.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_313_chart;
$(document).ready(function () {image_313_chart= new Highcharts.Chart({
...
$(image_313_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_313_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_313_chart.options.chart.options3d.alpha,
    beta = image_313_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_313_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_313_chart.options.chart.options3d.alpha = newAlpha;

      image_313_chart.redraw(false);
    },
...
var image_313_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_313_button').click(function () {image_313.yAxis[0].update({
            type: types[type]
        });
type += 1;

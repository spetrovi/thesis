...
// Set up the chart
var image_869_chart;
$(document).ready(function () {image_869_chart= new Highcharts.Chart({
...
$(image_869_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_869_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_869_chart.options.chart.options3d.alpha,
    beta = image_869_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_869_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_869_chart.options.chart.options3d.alpha = newAlpha;

      image_869_chart.redraw(false);
    },
...
var image_869_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_869_button').click(function () {image_869.yAxis[0].update({
            type: types[type]
        });
type += 1;

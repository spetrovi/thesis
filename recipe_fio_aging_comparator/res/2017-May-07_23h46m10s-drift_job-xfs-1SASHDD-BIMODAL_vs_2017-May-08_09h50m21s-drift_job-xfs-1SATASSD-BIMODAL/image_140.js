...
// Set up the chart
var image_140_chart;
$(document).ready(function () {image_140_chart= new Highcharts.Chart({
...
$(image_140_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_140_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_140_chart.options.chart.options3d.alpha,
    beta = image_140_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_140_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_140_chart.options.chart.options3d.alpha = newAlpha;

      image_140_chart.redraw(false);
    },
...
var image_140_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_140_button').click(function () {image_140.yAxis[0].update({
            type: types[type]
        });
type += 1;

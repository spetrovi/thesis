...
// Set up the chart
var image_464_chart;
$(document).ready(function () {image_464_chart= new Highcharts.Chart({
...
$(image_464_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_464_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_464_chart.options.chart.options3d.alpha,
    beta = image_464_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_464_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_464_chart.options.chart.options3d.alpha = newAlpha;

      image_464_chart.redraw(false);
    },
...
var image_464_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_464_button').click(function () {image_464.yAxis[0].update({
            type: types[type]
        });
type += 1;

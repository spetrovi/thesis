...
// Set up the chart
var image_130_chart;
$(document).ready(function () {image_130_chart= new Highcharts.Chart({
...
$(image_130_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_130_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_130_chart.options.chart.options3d.alpha,
    beta = image_130_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_130_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_130_chart.options.chart.options3d.alpha = newAlpha;

      image_130_chart.redraw(false);
    },
...
var image_130_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_130_button').click(function () {image_130.yAxis[0].update({
            type: types[type]
        });
type += 1;

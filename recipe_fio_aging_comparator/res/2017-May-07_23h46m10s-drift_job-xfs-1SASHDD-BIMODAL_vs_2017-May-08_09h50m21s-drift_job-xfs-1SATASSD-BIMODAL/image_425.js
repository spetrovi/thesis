...
// Set up the chart
var image_425_chart;
$(document).ready(function () {image_425_chart= new Highcharts.Chart({
...
$(image_425_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_425_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_425_chart.options.chart.options3d.alpha,
    beta = image_425_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_425_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_425_chart.options.chart.options3d.alpha = newAlpha;

      image_425_chart.redraw(false);
    },
...
var image_425_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_425_button').click(function () {image_425.yAxis[0].update({
            type: types[type]
        });
type += 1;

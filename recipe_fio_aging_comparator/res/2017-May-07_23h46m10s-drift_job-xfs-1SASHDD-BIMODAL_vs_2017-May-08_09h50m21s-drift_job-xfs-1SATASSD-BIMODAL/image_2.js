...
// Set up the chart
var image_2_chart;
$(document).ready(function () {image_2_chart= new Highcharts.Chart({
...
$(image_2_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_2_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_2_chart.options.chart.options3d.alpha,
    beta = image_2_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_2_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_2_chart.options.chart.options3d.alpha = newAlpha;

      image_2_chart.redraw(false);
    },
...
var image_2_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_2_button').click(function () {image_2.yAxis[0].update({
            type: types[type]
        });
type += 1;

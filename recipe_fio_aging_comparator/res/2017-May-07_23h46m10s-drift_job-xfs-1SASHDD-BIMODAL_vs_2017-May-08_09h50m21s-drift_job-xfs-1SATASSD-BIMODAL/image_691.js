...
// Set up the chart
var image_691_chart;
$(document).ready(function () {image_691_chart= new Highcharts.Chart({
...
$(image_691_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_691_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_691_chart.options.chart.options3d.alpha,
    beta = image_691_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_691_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_691_chart.options.chart.options3d.alpha = newAlpha;

      image_691_chart.redraw(false);
    },
...
var image_691_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_691_button').click(function () {image_691.yAxis[0].update({
            type: types[type]
        });
type += 1;

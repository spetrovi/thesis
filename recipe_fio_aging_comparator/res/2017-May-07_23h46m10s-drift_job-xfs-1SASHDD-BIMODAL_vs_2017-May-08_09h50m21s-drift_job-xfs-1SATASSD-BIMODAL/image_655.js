...
// Set up the chart
var image_655_chart;
$(document).ready(function () {image_655_chart= new Highcharts.Chart({
...
$(image_655_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_655_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_655_chart.options.chart.options3d.alpha,
    beta = image_655_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_655_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_655_chart.options.chart.options3d.alpha = newAlpha;

      image_655_chart.redraw(false);
    },
...
var image_655_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_655_button').click(function () {image_655.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_484_chart;
$(document).ready(function () {image_484_chart= new Highcharts.Chart({
...
$(image_484_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_484_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_484_chart.options.chart.options3d.alpha,
    beta = image_484_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_484_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_484_chart.options.chart.options3d.alpha = newAlpha;

      image_484_chart.redraw(false);
    },
...
var image_484_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_484_button').click(function () {image_484.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_662_chart;
$(document).ready(function () {image_662_chart= new Highcharts.Chart({
...
$(image_662_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_662_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_662_chart.options.chart.options3d.alpha,
    beta = image_662_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_662_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_662_chart.options.chart.options3d.alpha = newAlpha;

      image_662_chart.redraw(false);
    },
...
var image_662_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_662_button').click(function () {image_662.yAxis[0].update({
            type: types[type]
        });
type += 1;

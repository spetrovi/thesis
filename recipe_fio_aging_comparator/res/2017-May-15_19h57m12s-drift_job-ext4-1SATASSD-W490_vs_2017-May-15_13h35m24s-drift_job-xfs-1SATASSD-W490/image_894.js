...
image_894_chart= new Highcharts.Chart({
...
$(image_894_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_894_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_894_chart.options.chart.options3d.alpha,
    beta = image_894_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_894_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_894_chart.options.chart.options3d.alpha = newAlpha;

      image_894_chart.redraw(false);
    },
...
var image_894_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_894_button').click(function () {image_894.yAxis[0].update({
            type: types[type]
        });
type += 1;

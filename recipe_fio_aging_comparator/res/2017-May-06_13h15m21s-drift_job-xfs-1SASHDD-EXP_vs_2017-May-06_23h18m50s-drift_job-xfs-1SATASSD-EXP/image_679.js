...
// Set up the chart
var image_679_chart;
$(document).ready(function () {image_679_chart= new Highcharts.Chart({
...
$(image_679_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_679_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_679_chart.options.chart.options3d.alpha,
    beta = image_679_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_679_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_679_chart.options.chart.options3d.alpha = newAlpha;

      image_679_chart.redraw(false);
    },
...
var image_679_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_679_button').click(function () {image_679.yAxis[0].update({
            type: types[type]
        });
type += 1;

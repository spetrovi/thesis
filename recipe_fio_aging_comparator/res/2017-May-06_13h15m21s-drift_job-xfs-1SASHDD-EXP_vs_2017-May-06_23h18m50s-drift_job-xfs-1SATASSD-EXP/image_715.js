...
// Set up the chart
var image_715_chart;
$(document).ready(function () {image_715_chart= new Highcharts.Chart({
...
$(image_715_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_715_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_715_chart.options.chart.options3d.alpha,
    beta = image_715_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_715_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_715_chart.options.chart.options3d.alpha = newAlpha;

      image_715_chart.redraw(false);
    },
...
var image_715_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_715_button').click(function () {image_715.yAxis[0].update({
            type: types[type]
        });
type += 1;

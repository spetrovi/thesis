...
// Set up the chart
var image_608_chart;
$(document).ready(function () {image_608_chart= new Highcharts.Chart({
...
$(image_608_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_608_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_608_chart.options.chart.options3d.alpha,
    beta = image_608_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_608_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_608_chart.options.chart.options3d.alpha = newAlpha;

      image_608_chart.redraw(false);
    },
...
var image_608_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_608_button').click(function () {image_608.yAxis[0].update({
            type: types[type]
        });
type += 1;

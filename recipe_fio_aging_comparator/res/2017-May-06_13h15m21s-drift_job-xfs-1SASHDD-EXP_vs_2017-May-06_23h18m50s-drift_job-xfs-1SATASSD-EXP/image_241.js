...
// Set up the chart
var image_241_chart;
$(document).ready(function () {image_241_chart= new Highcharts.Chart({
...
$(image_241_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_241_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_241_chart.options.chart.options3d.alpha,
    beta = image_241_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_241_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_241_chart.options.chart.options3d.alpha = newAlpha;

      image_241_chart.redraw(false);
    },
...
var image_241_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_241_button').click(function () {image_241.yAxis[0].update({
            type: types[type]
        });
type += 1;

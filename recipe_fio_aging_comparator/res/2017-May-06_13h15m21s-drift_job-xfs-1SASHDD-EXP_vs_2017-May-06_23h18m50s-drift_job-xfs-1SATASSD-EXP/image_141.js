...
// Set up the chart
var image_141_chart;
$(document).ready(function () {image_141_chart= new Highcharts.Chart({
...
$(image_141_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_141_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_141_chart.options.chart.options3d.alpha,
    beta = image_141_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_141_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_141_chart.options.chart.options3d.alpha = newAlpha;

      image_141_chart.redraw(false);
    },
...
var image_141_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_141_button').click(function () {image_141.yAxis[0].update({
            type: types[type]
        });
type += 1;

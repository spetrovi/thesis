...
// Set up the chart
var image_652_chart;
$(document).ready(function () {image_652_chart= new Highcharts.Chart({
...
$(image_652_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_652_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_652_chart.options.chart.options3d.alpha,
    beta = image_652_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_652_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_652_chart.options.chart.options3d.alpha = newAlpha;

      image_652_chart.redraw(false);
    },
...
var image_652_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_652_button').click(function () {image_652.yAxis[0].update({
            type: types[type]
        });
type += 1;

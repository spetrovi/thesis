...
// Set up the chart
var image_582_chart;
$(document).ready(function () {image_582_chart= new Highcharts.Chart({
...
$(image_582_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_582_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_582_chart.options.chart.options3d.alpha,
    beta = image_582_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_582_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_582_chart.options.chart.options3d.alpha = newAlpha;

      image_582_chart.redraw(false);
    },
...
var image_582_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_582_button').click(function () {image_582.yAxis[0].update({
            type: types[type]
        });
type += 1;

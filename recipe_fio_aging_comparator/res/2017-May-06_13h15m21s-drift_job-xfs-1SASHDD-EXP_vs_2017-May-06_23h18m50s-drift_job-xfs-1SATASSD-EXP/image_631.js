...
// Set up the chart
var image_631_chart;
$(document).ready(function () {image_631_chart= new Highcharts.Chart({
...
$(image_631_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_631_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_631_chart.options.chart.options3d.alpha,
    beta = image_631_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_631_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_631_chart.options.chart.options3d.alpha = newAlpha;

      image_631_chart.redraw(false);
    },
...
var image_631_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_631_button').click(function () {image_631.yAxis[0].update({
            type: types[type]
        });
type += 1;

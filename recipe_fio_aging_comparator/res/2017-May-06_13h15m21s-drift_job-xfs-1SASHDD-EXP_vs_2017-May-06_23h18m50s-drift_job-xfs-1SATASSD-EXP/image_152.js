...
// Set up the chart
var image_152_chart;
$(document).ready(function () {image_152_chart= new Highcharts.Chart({
...
$(image_152_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_152_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_152_chart.options.chart.options3d.alpha,
    beta = image_152_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_152_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_152_chart.options.chart.options3d.alpha = newAlpha;

      image_152_chart.redraw(false);
    },
...
var image_152_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_152_button').click(function () {image_152.yAxis[0].update({
            type: types[type]
        });
type += 1;

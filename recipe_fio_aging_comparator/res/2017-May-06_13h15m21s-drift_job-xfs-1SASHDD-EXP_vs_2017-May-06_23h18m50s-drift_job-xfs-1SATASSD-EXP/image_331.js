...
// Set up the chart
var image_331_chart;
$(document).ready(function () {image_331_chart= new Highcharts.Chart({
...
$(image_331_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_331_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_331_chart.options.chart.options3d.alpha,
    beta = image_331_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_331_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_331_chart.options.chart.options3d.alpha = newAlpha;

      image_331_chart.redraw(false);
    },
...
var image_331_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_331_button').click(function () {image_331.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_366_chart;
$(document).ready(function () {image_366_chart= new Highcharts.Chart({
...
$(image_366_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_366_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_366_chart.options.chart.options3d.alpha,
    beta = image_366_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_366_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_366_chart.options.chart.options3d.alpha = newAlpha;

      image_366_chart.redraw(false);
    },
...
var image_366_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_366_button').click(function () {image_366.yAxis[0].update({
            type: types[type]
        });
type += 1;

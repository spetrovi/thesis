...
// Set up the chart
var image_225_chart;
$(document).ready(function () {image_225_chart= new Highcharts.Chart({
...
$(image_225_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_225_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_225_chart.options.chart.options3d.alpha,
    beta = image_225_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_225_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_225_chart.options.chart.options3d.alpha = newAlpha;

      image_225_chart.redraw(false);
    },
...
var image_225_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_225_button').click(function () {image_225.yAxis[0].update({
            type: types[type]
        });
type += 1;

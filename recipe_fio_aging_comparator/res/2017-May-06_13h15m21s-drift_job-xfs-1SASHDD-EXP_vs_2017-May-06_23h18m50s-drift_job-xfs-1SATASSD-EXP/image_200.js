...
// Set up the chart
var image_200_chart;
$(document).ready(function () {image_200_chart= new Highcharts.Chart({
...
$(image_200_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_200_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_200_chart.options.chart.options3d.alpha,
    beta = image_200_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_200_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_200_chart.options.chart.options3d.alpha = newAlpha;

      image_200_chart.redraw(false);
    },
...
var image_200_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_200_button').click(function () {image_200.yAxis[0].update({
            type: types[type]
        });
type += 1;

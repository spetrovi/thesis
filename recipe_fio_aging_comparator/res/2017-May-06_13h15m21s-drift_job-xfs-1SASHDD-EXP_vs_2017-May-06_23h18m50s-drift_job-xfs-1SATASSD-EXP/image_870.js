...
// Set up the chart
var image_870_chart;
$(document).ready(function () {image_870_chart= new Highcharts.Chart({
...
$(image_870_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_870_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_870_chart.options.chart.options3d.alpha,
    beta = image_870_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_870_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_870_chart.options.chart.options3d.alpha = newAlpha;

      image_870_chart.redraw(false);
    },
...
var image_870_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_870_button').click(function () {image_870.yAxis[0].update({
            type: types[type]
        });
type += 1;

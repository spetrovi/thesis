...
// Set up the chart
var image_297_chart;
$(document).ready(function () {image_297_chart= new Highcharts.Chart({
...
$(image_297_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_297_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_297_chart.options.chart.options3d.alpha,
    beta = image_297_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_297_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_297_chart.options.chart.options3d.alpha = newAlpha;

      image_297_chart.redraw(false);
    },
...
var image_297_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_297_button').click(function () {image_297.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_328_chart;
$(document).ready(function () {image_328_chart= new Highcharts.Chart({
...
$(image_328_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_328_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_328_chart.options.chart.options3d.alpha,
    beta = image_328_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_328_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_328_chart.options.chart.options3d.alpha = newAlpha;

      image_328_chart.redraw(false);
    },
...
var image_328_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_328_button').click(function () {image_328.yAxis[0].update({
            type: types[type]
        });
type += 1;

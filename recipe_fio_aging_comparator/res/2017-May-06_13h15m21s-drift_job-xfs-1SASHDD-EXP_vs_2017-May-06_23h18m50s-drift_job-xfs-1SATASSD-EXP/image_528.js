...
// Set up the chart
var image_528_chart;
$(document).ready(function () {image_528_chart= new Highcharts.Chart({
...
$(image_528_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_528_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_528_chart.options.chart.options3d.alpha,
    beta = image_528_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_528_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_528_chart.options.chart.options3d.alpha = newAlpha;

      image_528_chart.redraw(false);
    },
...
var image_528_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_528_button').click(function () {image_528.yAxis[0].update({
            type: types[type]
        });
type += 1;

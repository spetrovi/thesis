...
// Set up the chart
var image_656_chart;
$(document).ready(function () {image_656_chart= new Highcharts.Chart({
...
$(image_656_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_656_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_656_chart.options.chart.options3d.alpha,
    beta = image_656_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_656_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_656_chart.options.chart.options3d.alpha = newAlpha;

      image_656_chart.redraw(false);
    },
...
var image_656_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_656_button').click(function () {image_656.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_374_chart;
$(document).ready(function () {image_374_chart= new Highcharts.Chart({
...
$(image_374_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_374_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_374_chart.options.chart.options3d.alpha,
    beta = image_374_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_374_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_374_chart.options.chart.options3d.alpha = newAlpha;

      image_374_chart.redraw(false);
    },
...
var image_374_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_374_button').click(function () {image_374.yAxis[0].update({
            type: types[type]
        });
type += 1;

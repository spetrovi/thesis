...
// Set up the chart
var image_466_chart;
$(document).ready(function () {image_466_chart= new Highcharts.Chart({
...
$(image_466_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_466_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_466_chart.options.chart.options3d.alpha,
    beta = image_466_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_466_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_466_chart.options.chart.options3d.alpha = newAlpha;

      image_466_chart.redraw(false);
    },
...
var image_466_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_466_button').click(function () {image_466.yAxis[0].update({
            type: types[type]
        });
type += 1;

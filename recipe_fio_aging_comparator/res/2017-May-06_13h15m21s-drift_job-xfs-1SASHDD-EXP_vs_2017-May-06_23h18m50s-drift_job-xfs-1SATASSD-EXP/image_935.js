...
// Set up the chart
var image_935_chart;
$(document).ready(function () {image_935_chart= new Highcharts.Chart({
...
$(image_935_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_935_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_935_chart.options.chart.options3d.alpha,
    beta = image_935_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_935_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_935_chart.options.chart.options3d.alpha = newAlpha;

      image_935_chart.redraw(false);
    },
...
var image_935_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_935_button').click(function () {image_935.yAxis[0].update({
            type: types[type]
        });
type += 1;

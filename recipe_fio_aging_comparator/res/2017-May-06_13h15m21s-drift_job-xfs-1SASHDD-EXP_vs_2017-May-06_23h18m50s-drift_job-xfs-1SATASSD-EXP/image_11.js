...
// Set up the chart
var image_11_chart;
$(document).ready(function () {image_11_chart= new Highcharts.Chart({
...
$(image_11_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_11_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_11_chart.options.chart.options3d.alpha,
    beta = image_11_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_11_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_11_chart.options.chart.options3d.alpha = newAlpha;

      image_11_chart.redraw(false);
    },
...
var image_11_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_11_button').click(function () {image_11.yAxis[0].update({
            type: types[type]
        });
type += 1;

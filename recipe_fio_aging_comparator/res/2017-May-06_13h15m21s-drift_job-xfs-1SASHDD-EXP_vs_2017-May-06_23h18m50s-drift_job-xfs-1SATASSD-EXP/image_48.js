...
// Set up the chart
var image_48_chart;
$(document).ready(function () {image_48_chart= new Highcharts.Chart({
...
$(image_48_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_48_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_48_chart.options.chart.options3d.alpha,
    beta = image_48_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_48_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_48_chart.options.chart.options3d.alpha = newAlpha;

      image_48_chart.redraw(false);
    },
...
var image_48_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_48_button').click(function () {image_48.yAxis[0].update({
            type: types[type]
        });
type += 1;

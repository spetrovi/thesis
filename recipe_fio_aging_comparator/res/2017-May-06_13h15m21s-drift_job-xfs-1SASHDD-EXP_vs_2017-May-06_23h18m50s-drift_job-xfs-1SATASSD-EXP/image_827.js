...
// Set up the chart
var image_827_chart;
$(document).ready(function () {image_827_chart= new Highcharts.Chart({
...
$(image_827_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_827_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_827_chart.options.chart.options3d.alpha,
    beta = image_827_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_827_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_827_chart.options.chart.options3d.alpha = newAlpha;

      image_827_chart.redraw(false);
    },
...
var image_827_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_827_button').click(function () {image_827.yAxis[0].update({
            type: types[type]
        });
type += 1;

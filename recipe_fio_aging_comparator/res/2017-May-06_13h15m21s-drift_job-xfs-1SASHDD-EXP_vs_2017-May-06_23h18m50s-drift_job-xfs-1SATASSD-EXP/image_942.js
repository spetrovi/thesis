...
// Set up the chart
var image_942_chart;
$(document).ready(function () {image_942_chart= new Highcharts.Chart({
...
$(image_942_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_942_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_942_chart.options.chart.options3d.alpha,
    beta = image_942_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_942_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_942_chart.options.chart.options3d.alpha = newAlpha;

      image_942_chart.redraw(false);
    },
...
var image_942_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_942_button').click(function () {image_942.yAxis[0].update({
            type: types[type]
        });
type += 1;

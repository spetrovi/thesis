...
// Set up the chart
var image_941_chart;
$(document).ready(function () {image_941_chart= new Highcharts.Chart({
...
$(image_941_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_941_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_941_chart.options.chart.options3d.alpha,
    beta = image_941_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_941_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_941_chart.options.chart.options3d.alpha = newAlpha;

      image_941_chart.redraw(false);
    },
...
var image_941_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_941_button').click(function () {image_941.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_890_chart;
$(document).ready(function () {image_890_chart= new Highcharts.Chart({
...
$(image_890_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_890_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_890_chart.options.chart.options3d.alpha,
    beta = image_890_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_890_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_890_chart.options.chart.options3d.alpha = newAlpha;

      image_890_chart.redraw(false);
    },
...
var image_890_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_890_button').click(function () {image_890.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_217_chart;
$(document).ready(function () {image_217_chart= new Highcharts.Chart({
...
$(image_217_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_217_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_217_chart.options.chart.options3d.alpha,
    beta = image_217_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_217_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_217_chart.options.chart.options3d.alpha = newAlpha;

      image_217_chart.redraw(false);
    },
...
var image_217_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_217_button').click(function () {image_217.yAxis[0].update({
            type: types[type]
        });
type += 1;

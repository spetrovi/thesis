...
// Set up the chart
var image_18_chart;
$(document).ready(function () {image_18_chart= new Highcharts.Chart({
...
$(image_18_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_18_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_18_chart.options.chart.options3d.alpha,
    beta = image_18_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_18_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_18_chart.options.chart.options3d.alpha = newAlpha;

      image_18_chart.redraw(false);
    },
...
var image_18_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_18_button').click(function () {image_18.yAxis[0].update({
            type: types[type]
        });
type += 1;

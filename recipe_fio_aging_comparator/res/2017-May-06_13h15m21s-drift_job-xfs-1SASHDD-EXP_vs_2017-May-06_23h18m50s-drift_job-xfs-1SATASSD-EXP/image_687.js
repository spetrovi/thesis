...
// Set up the chart
var image_687_chart;
$(document).ready(function () {image_687_chart= new Highcharts.Chart({
...
$(image_687_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_687_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_687_chart.options.chart.options3d.alpha,
    beta = image_687_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_687_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_687_chart.options.chart.options3d.alpha = newAlpha;

      image_687_chart.redraw(false);
    },
...
var image_687_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_687_button').click(function () {image_687.yAxis[0].update({
            type: types[type]
        });
type += 1;

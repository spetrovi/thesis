...
// Set up the chart
var image_769_chart;
$(document).ready(function () {image_769_chart= new Highcharts.Chart({
...
$(image_769_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_769_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_769_chart.options.chart.options3d.alpha,
    beta = image_769_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_769_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_769_chart.options.chart.options3d.alpha = newAlpha;

      image_769_chart.redraw(false);
    },
...
var image_769_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_769_button').click(function () {image_769.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_460_chart;
$(document).ready(function () {image_460_chart= new Highcharts.Chart({
...
$(image_460_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_460_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_460_chart.options.chart.options3d.alpha,
    beta = image_460_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_460_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_460_chart.options.chart.options3d.alpha = newAlpha;

      image_460_chart.redraw(false);
    },
...
var image_460_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_460_button').click(function () {image_460.yAxis[0].update({
            type: types[type]
        });
type += 1;

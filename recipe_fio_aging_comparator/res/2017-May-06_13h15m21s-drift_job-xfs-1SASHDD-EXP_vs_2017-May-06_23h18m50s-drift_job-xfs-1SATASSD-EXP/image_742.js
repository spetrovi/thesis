...
// Set up the chart
var image_742_chart;
$(document).ready(function () {image_742_chart= new Highcharts.Chart({
...
$(image_742_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_742_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_742_chart.options.chart.options3d.alpha,
    beta = image_742_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_742_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_742_chart.options.chart.options3d.alpha = newAlpha;

      image_742_chart.redraw(false);
    },
...
var image_742_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_742_button').click(function () {image_742.yAxis[0].update({
            type: types[type]
        });
type += 1;

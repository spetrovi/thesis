...
// Set up the chart
var image_996_chart;
$(document).ready(function () {image_996_chart= new Highcharts.Chart({
...
$(image_996_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_996_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_996_chart.options.chart.options3d.alpha,
    beta = image_996_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_996_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_996_chart.options.chart.options3d.alpha = newAlpha;

      image_996_chart.redraw(false);
    },
...
var image_996_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_996_button').click(function () {image_996.yAxis[0].update({
            type: types[type]
        });
type += 1;

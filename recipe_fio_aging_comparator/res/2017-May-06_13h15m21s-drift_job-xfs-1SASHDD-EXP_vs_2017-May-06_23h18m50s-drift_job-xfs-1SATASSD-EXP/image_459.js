...
// Set up the chart
var image_459_chart;
$(document).ready(function () {image_459_chart= new Highcharts.Chart({
...
$(image_459_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_459_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_459_chart.options.chart.options3d.alpha,
    beta = image_459_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_459_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_459_chart.options.chart.options3d.alpha = newAlpha;

      image_459_chart.redraw(false);
    },
...
var image_459_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_459_button').click(function () {image_459.yAxis[0].update({
            type: types[type]
        });
type += 1;

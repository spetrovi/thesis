...
// Set up the chart
var image_721_chart;
$(document).ready(function () {image_721_chart= new Highcharts.Chart({
...
$(image_721_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_721_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_721_chart.options.chart.options3d.alpha,
    beta = image_721_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_721_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_721_chart.options.chart.options3d.alpha = newAlpha;

      image_721_chart.redraw(false);
    },
...
var image_721_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_721_button').click(function () {image_721.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_376_chart;
$(document).ready(function () {image_376_chart= new Highcharts.Chart({
...
$(image_376_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_376_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_376_chart.options.chart.options3d.alpha,
    beta = image_376_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_376_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_376_chart.options.chart.options3d.alpha = newAlpha;

      image_376_chart.redraw(false);
    },
...
var image_376_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_376_button').click(function () {image_376.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_667_chart;
$(document).ready(function () {image_667_chart= new Highcharts.Chart({
...
$(image_667_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_667_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_667_chart.options.chart.options3d.alpha,
    beta = image_667_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_667_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_667_chart.options.chart.options3d.alpha = newAlpha;

      image_667_chart.redraw(false);
    },
...
var image_667_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_667_button').click(function () {image_667.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_923_chart;
$(document).ready(function () {image_923_chart= new Highcharts.Chart({
...
$(image_923_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_923_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_923_chart.options.chart.options3d.alpha,
    beta = image_923_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_923_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_923_chart.options.chart.options3d.alpha = newAlpha;

      image_923_chart.redraw(false);
    },
...
var image_923_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_923_button').click(function () {image_923.yAxis[0].update({
            type: types[type]
        });
type += 1;

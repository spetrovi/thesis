...
// Set up the chart
var image_424_chart;
$(document).ready(function () {image_424_chart= new Highcharts.Chart({
...
$(image_424_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_424_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_424_chart.options.chart.options3d.alpha,
    beta = image_424_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_424_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_424_chart.options.chart.options3d.alpha = newAlpha;

      image_424_chart.redraw(false);
    },
...
var image_424_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_424_button').click(function () {image_424.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_110_chart;
$(document).ready(function () {image_110_chart= new Highcharts.Chart({
...
$(image_110_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_110_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_110_chart.options.chart.options3d.alpha,
    beta = image_110_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_110_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_110_chart.options.chart.options3d.alpha = newAlpha;

      image_110_chart.redraw(false);
    },
...
var image_110_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_110_button').click(function () {image_110.yAxis[0].update({
            type: types[type]
        });
type += 1;

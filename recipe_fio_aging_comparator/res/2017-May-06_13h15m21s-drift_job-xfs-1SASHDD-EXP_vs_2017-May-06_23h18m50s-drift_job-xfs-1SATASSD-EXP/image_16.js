...
// Set up the chart
var image_16_chart;
$(document).ready(function () {image_16_chart= new Highcharts.Chart({
...
$(image_16_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_16_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_16_chart.options.chart.options3d.alpha,
    beta = image_16_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_16_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_16_chart.options.chart.options3d.alpha = newAlpha;

      image_16_chart.redraw(false);
    },
...
var image_16_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_16_button').click(function () {image_16.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_346_chart;
$(document).ready(function () {image_346_chart= new Highcharts.Chart({
...
$(image_346_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_346_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_346_chart.options.chart.options3d.alpha,
    beta = image_346_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_346_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_346_chart.options.chart.options3d.alpha = newAlpha;

      image_346_chart.redraw(false);
    },
...
var image_346_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_346_button').click(function () {image_346.yAxis[0].update({
            type: types[type]
        });
type += 1;

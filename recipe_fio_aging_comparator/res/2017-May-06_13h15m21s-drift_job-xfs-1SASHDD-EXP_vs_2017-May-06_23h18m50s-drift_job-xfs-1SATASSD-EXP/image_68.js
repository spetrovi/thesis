...
// Set up the chart
var image_68_chart;
$(document).ready(function () {image_68_chart= new Highcharts.Chart({
...
$(image_68_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_68_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_68_chart.options.chart.options3d.alpha,
    beta = image_68_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_68_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_68_chart.options.chart.options3d.alpha = newAlpha;

      image_68_chart.redraw(false);
    },
...
var image_68_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_68_button').click(function () {image_68.yAxis[0].update({
            type: types[type]
        });
type += 1;

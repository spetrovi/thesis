...
// Set up the chart
var image_281_chart;
$(document).ready(function () {image_281_chart= new Highcharts.Chart({
...
$(image_281_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_281_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_281_chart.options.chart.options3d.alpha,
    beta = image_281_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_281_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_281_chart.options.chart.options3d.alpha = newAlpha;

      image_281_chart.redraw(false);
    },
...
var image_281_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_281_button').click(function () {image_281.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_410_chart;
$(document).ready(function () {image_410_chart= new Highcharts.Chart({
...
$(image_410_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_410_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_410_chart.options.chart.options3d.alpha,
    beta = image_410_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_410_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_410_chart.options.chart.options3d.alpha = newAlpha;

      image_410_chart.redraw(false);
    },
...
var image_410_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_410_button').click(function () {image_410.yAxis[0].update({
            type: types[type]
        });
type += 1;

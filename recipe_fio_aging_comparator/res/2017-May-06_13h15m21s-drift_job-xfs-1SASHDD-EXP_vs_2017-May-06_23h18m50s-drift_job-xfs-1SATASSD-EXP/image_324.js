...
// Set up the chart
var image_324_chart;
$(document).ready(function () {image_324_chart= new Highcharts.Chart({
...
$(image_324_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_324_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_324_chart.options.chart.options3d.alpha,
    beta = image_324_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_324_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_324_chart.options.chart.options3d.alpha = newAlpha;

      image_324_chart.redraw(false);
    },
...
var image_324_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_324_button').click(function () {image_324.yAxis[0].update({
            type: types[type]
        });
type += 1;

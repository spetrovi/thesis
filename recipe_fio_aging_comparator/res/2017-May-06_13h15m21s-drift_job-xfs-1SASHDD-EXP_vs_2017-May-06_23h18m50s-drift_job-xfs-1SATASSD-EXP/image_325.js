...
// Set up the chart
var image_325_chart;
$(document).ready(function () {image_325_chart= new Highcharts.Chart({
...
$(image_325_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_325_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_325_chart.options.chart.options3d.alpha,
    beta = image_325_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_325_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_325_chart.options.chart.options3d.alpha = newAlpha;

      image_325_chart.redraw(false);
    },
...
var image_325_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_325_button').click(function () {image_325.yAxis[0].update({
            type: types[type]
        });
type += 1;

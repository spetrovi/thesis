...
// Set up the chart
var image_99_chart;
$(document).ready(function () {image_99_chart= new Highcharts.Chart({
...
$(image_99_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_99_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_99_chart.options.chart.options3d.alpha,
    beta = image_99_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_99_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_99_chart.options.chart.options3d.alpha = newAlpha;

      image_99_chart.redraw(false);
    },
...
var image_99_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_99_button').click(function () {image_99.yAxis[0].update({
            type: types[type]
        });
type += 1;

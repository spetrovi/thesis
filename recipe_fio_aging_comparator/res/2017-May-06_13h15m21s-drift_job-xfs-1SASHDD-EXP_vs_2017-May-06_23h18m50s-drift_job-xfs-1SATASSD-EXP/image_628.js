...
// Set up the chart
var image_628_chart;
$(document).ready(function () {image_628_chart= new Highcharts.Chart({
...
$(image_628_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_628_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_628_chart.options.chart.options3d.alpha,
    beta = image_628_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_628_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_628_chart.options.chart.options3d.alpha = newAlpha;

      image_628_chart.redraw(false);
    },
...
var image_628_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_628_button').click(function () {image_628.yAxis[0].update({
            type: types[type]
        });
type += 1;

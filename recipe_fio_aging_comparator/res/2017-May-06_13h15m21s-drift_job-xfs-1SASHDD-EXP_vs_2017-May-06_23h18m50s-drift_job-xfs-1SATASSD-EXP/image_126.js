...
// Set up the chart
var image_126_chart;
$(document).ready(function () {image_126_chart= new Highcharts.Chart({
...
$(image_126_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_126_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_126_chart.options.chart.options3d.alpha,
    beta = image_126_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_126_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_126_chart.options.chart.options3d.alpha = newAlpha;

      image_126_chart.redraw(false);
    },
...
var image_126_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_126_button').click(function () {image_126.yAxis[0].update({
            type: types[type]
        });
type += 1;

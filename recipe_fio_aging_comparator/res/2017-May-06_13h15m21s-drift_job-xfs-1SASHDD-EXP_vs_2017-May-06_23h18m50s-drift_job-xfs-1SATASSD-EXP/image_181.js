...
// Set up the chart
var image_181_chart;
$(document).ready(function () {image_181_chart= new Highcharts.Chart({
...
$(image_181_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_181_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_181_chart.options.chart.options3d.alpha,
    beta = image_181_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_181_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_181_chart.options.chart.options3d.alpha = newAlpha;

      image_181_chart.redraw(false);
    },
...
var image_181_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_181_button').click(function () {image_181.yAxis[0].update({
            type: types[type]
        });
type += 1;

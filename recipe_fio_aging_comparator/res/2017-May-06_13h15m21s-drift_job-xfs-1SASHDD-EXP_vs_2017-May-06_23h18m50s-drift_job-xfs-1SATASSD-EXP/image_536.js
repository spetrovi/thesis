...
// Set up the chart
var image_536_chart;
$(document).ready(function () {image_536_chart= new Highcharts.Chart({
...
$(image_536_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_536_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_536_chart.options.chart.options3d.alpha,
    beta = image_536_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_536_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_536_chart.options.chart.options3d.alpha = newAlpha;

      image_536_chart.redraw(false);
    },
...
var image_536_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_536_button').click(function () {image_536.yAxis[0].update({
            type: types[type]
        });
type += 1;

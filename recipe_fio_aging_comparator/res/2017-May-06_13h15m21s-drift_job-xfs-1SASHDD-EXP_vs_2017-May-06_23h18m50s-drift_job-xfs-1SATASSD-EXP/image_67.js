...
// Set up the chart
var image_67_chart;
$(document).ready(function () {image_67_chart= new Highcharts.Chart({
...
$(image_67_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_67_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_67_chart.options.chart.options3d.alpha,
    beta = image_67_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_67_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_67_chart.options.chart.options3d.alpha = newAlpha;

      image_67_chart.redraw(false);
    },
...
var image_67_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_67_button').click(function () {image_67.yAxis[0].update({
            type: types[type]
        });
type += 1;

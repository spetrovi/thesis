...
// Set up the chart
var image_570_chart;
$(document).ready(function () {image_570_chart= new Highcharts.Chart({
...
$(image_570_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_570_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_570_chart.options.chart.options3d.alpha,
    beta = image_570_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_570_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_570_chart.options.chart.options3d.alpha = newAlpha;

      image_570_chart.redraw(false);
    },
...
var image_570_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_570_button').click(function () {image_570.yAxis[0].update({
            type: types[type]
        });
type += 1;

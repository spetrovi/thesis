...
// Set up the chart
var image_563_chart;
$(document).ready(function () {image_563_chart= new Highcharts.Chart({
...
$(image_563_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_563_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_563_chart.options.chart.options3d.alpha,
    beta = image_563_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_563_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_563_chart.options.chart.options3d.alpha = newAlpha;

      image_563_chart.redraw(false);
    },
...
var image_563_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_563_button').click(function () {image_563.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_323_chart;
$(document).ready(function () {image_323_chart= new Highcharts.Chart({
...
$(image_323_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_323_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_323_chart.options.chart.options3d.alpha,
    beta = image_323_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_323_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_323_chart.options.chart.options3d.alpha = newAlpha;

      image_323_chart.redraw(false);
    },
...
var image_323_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_323_button').click(function () {image_323.yAxis[0].update({
            type: types[type]
        });
type += 1;

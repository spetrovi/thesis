...
// Set up the chart
var image_989_chart;
$(document).ready(function () {image_989_chart= new Highcharts.Chart({
...
$(image_989_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_989_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_989_chart.options.chart.options3d.alpha,
    beta = image_989_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_989_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_989_chart.options.chart.options3d.alpha = newAlpha;

      image_989_chart.redraw(false);
    },
...
var image_989_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_989_button').click(function () {image_989.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_988_chart;
$(document).ready(function () {image_988_chart= new Highcharts.Chart({
...
$(image_988_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_988_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_988_chart.options.chart.options3d.alpha,
    beta = image_988_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_988_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_988_chart.options.chart.options3d.alpha = newAlpha;

      image_988_chart.redraw(false);
    },
...
var image_988_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_988_button').click(function () {image_988.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
color: 'rgba(0, 0, 255, 0.50)',
    ...
    $('#fs_4367_button').click(function () {fs_4367.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_648_chart;
$(document).ready(function () {image_648_chart= new Highcharts.Chart({
...
$(image_648_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_648_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_648_chart.options.chart.options3d.alpha,
    beta = image_648_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_648_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_648_chart.options.chart.options3d.alpha = newAlpha;

      image_648_chart.redraw(false);
    },
...
var image_648_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_648_button').click(function () {image_648.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_745_chart;
$(document).ready(function () {image_745_chart= new Highcharts.Chart({
...
$(image_745_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_745_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_745_chart.options.chart.options3d.alpha,
    beta = image_745_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_745_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_745_chart.options.chart.options3d.alpha = newAlpha;

      image_745_chart.redraw(false);
    },
...
var image_745_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_745_button').click(function () {image_745.yAxis[0].update({
            type: types[type]
        });
type += 1;

var fs_7653;
$(document).ready(function () {fs_7653= new Highcharts.Chart({
      chart: {zoomType: 'xy',
      width: 900,
      height: 600,
...
color: 'rgba(0, 0, 255, 0.50)',
	type: 'column',
	data: [0, 1, 1, 6, 12, 29, 64, 121, 201, 274, 529, 0, 0, 0, 0, 0, 0, 0, 0, 0],visible: true,
    ...
    $('#fs_7653_button').click(function () {fs_7653.yAxis[0].update({
            type: types[type]
        });
type += 1;

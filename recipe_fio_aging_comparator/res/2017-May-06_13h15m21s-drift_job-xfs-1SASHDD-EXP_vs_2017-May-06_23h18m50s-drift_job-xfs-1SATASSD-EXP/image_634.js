...
// Set up the chart
var image_634_chart;
$(document).ready(function () {image_634_chart= new Highcharts.Chart({
...
$(image_634_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_634_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_634_chart.options.chart.options3d.alpha,
    beta = image_634_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_634_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_634_chart.options.chart.options3d.alpha = newAlpha;

      image_634_chart.redraw(false);
    },
...
var image_634_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_634_button').click(function () {image_634.yAxis[0].update({
            type: types[type]
        });
type += 1;

...
// Set up the chart
var image_719_chart;
$(document).ready(function () {image_719_chart= new Highcharts.Chart({
...
$(image_719_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_719_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_719_chart.options.chart.options3d.alpha,
    beta = image_719_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_719_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_719_chart.options.chart.options3d.alpha = newAlpha;

      image_719_chart.redraw(false);
    },
...
var image_719_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_719_button').click(function () {image_719.yAxis[0].update({
            type: types[type]
        });
type += 1;

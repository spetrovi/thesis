...
// Set up the chart
var image_698_chart;
$(document).ready(function () {image_698_chart= new Highcharts.Chart({
...
$(image_698_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_698_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_698_chart.options.chart.options3d.alpha,
    beta = image_698_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_698_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_698_chart.options.chart.options3d.alpha = newAlpha;

      image_698_chart.redraw(false);
    },
...
var image_698_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_698_button').click(function () {image_698.yAxis[0].update({
            type: types[type]
        });
type += 1;

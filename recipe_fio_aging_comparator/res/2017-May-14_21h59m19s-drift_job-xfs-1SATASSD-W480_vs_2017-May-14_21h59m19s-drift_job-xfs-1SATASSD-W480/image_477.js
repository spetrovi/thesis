...
image_477_chart= new Highcharts.Chart({
...
$(image_477_chart.container).on('mousedown.hc touchstart.hc', function(eStart) {
  eStart = image_477_chart.pointer.normalize(eStart);

  var posX = eStart.pageX,
    posY = eStart.pageY,
    alpha = image_477_chart.options.chart.options3d.alpha,
    beta = image_477_chart.options.chart.options3d.beta,
    newAlpha,
    newBeta,
  ...
  $(document).on({
    'mousemove.hc touchdrag.hc': function(e) {
      ...
      image_477_chart.options.chart.options3d.beta = newBeta;

      // Run alpha
      newAlpha = alpha + (e.pageY - posY) / sensitivity;
      image_477_chart.options.chart.options3d.alpha = newAlpha;

      image_477_chart.redraw(false);
    },
...
var image_477_button = $('#container').highcharts(),
        type = 1,
        types = ['linear', 'logarithmic'],
        lineColor = 'red';

    $('#image_477_button').click(function () {image_477.yAxis[0].update({
            type: types[type]
        });
type += 1;
